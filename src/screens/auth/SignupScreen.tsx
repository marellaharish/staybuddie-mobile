    ...
    return (
        <>
            <SafeAreaView style={[styles.container,]}>
                ...
                <ImageBackground
                    source={{ uri: 'https://img.freepik.com/free-photo/3d-render-secure-login-password-illustration_107791-16640.jpg?ga=GA1.1.678449526.1710473925&semt=ais_hybrid&w=740' }}
                ...
                >
                    ...
                    <View style={[styles.content]}>
                        ...
                        <Text style={[styles.title]}>StayBuddie</Text>
                        ...
                        <View style={styles.footer}>
                            <Text style={styles.footerText}>
                                ...
                                <Text style={styles.signUpLink} onPress={() => navigate('Login')}> Login</Text>
                            </Text>
                        </View>
